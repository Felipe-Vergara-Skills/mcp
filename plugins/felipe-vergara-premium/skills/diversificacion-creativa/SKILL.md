...
# Skill premium: diversificacion-creativa

## ⚡ DIRECTIVA — léeme antes de cualquier otra cosa

Cuando esta skill se active porque el alumno pidió algo relacionado con `diversificacion-creativa`, sigue este flujo SIN excepciones:
