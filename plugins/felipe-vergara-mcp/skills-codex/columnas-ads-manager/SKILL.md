...
description: >
  Configura las columnas óptimas de Ads Manager según la metodología de Felipe Vergara. Úsala cuando el alumno pregunte qué columnas activar, cómo configurar ads manager, qué métricas ver, columnas recomendadas para Meta Ads.
---
